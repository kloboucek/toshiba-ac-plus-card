...
- The thermostat dial supports both pointer and touch drag handling. On mobile, vertical swipes over the dial/arc and center temperature readout are left to the dashboard page for scrolling; the visible slider arc and thumb have enlarged invisible grab areas for easier finger dragging without making the whole dial face consume scroll gestures.
