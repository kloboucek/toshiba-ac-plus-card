...
- The thermostat dial supports both pointer and touch drag handling. On mobile, vertical swipes over the dial/arc and center temperature readout are left to the dashboard page for scrolling; only the visible slider arc captures confirmed dial drags or taps.
